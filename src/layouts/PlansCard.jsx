...
const PlansCard = (props) => {
 const features = [
    "Free daily access to professional personal training.",
    "Enjoy full gym access anytime we're open.",
    "Explore and use all areas, with no restrictions.",
    "Benefit from our premium.",
 ];
